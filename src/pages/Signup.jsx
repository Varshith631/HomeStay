            ...
            <PageTransition>
                <div style={{ display: 'flex', width: '100%', minHeight: '80vh', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    >
                        ...
                        <p style={{ color: '#aaa', marginBottom: '30px' }}>Your account has been created successfully. You can now log in to the network.</p>
                    ...
                    {otpStep ? (
                        <form onSubmit={handleVerifyOtp} style={{ display: 'flex', flexDirection: 'column', gap: '25px' }}>
                            ...
                            <motion.button
                                ...
                                style={{ width: '100%', padding: '18px', background: 'linear-gradient(90deg, #7000ff, #00f0ff)', border: 'none', borderRadius: '12px', color: 'white', fontSize: '1.1rem', fontWeight: 600, cursor: isLoading ? 'wait' : 'pointer', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '10px' }}
                            >
                                {isLoading ? <motion.div animate={{ rotate: 360 }} transition={{ duration: 1, repeat: Infinity, ease: 'linear' }} style={{ width: '24px', height: '24px', border: '3px solid rgba(255,255,255,0.3)', borderTop: '3px solid white', borderRadius: '50%' }} /> : <>Verify & Complete <ArrowRight size={20} /></>}
                            </motion.button>
                        </form>
                    ) : (
                        <>
